...
const chapters: Chapter[] = [
  {
    ...
    body: "Singularity offers a system for builders and investors to coordinate capital together.",
    cta: {
  ...
  },
  {
    ...
    body: "Aligned investors can discover new missions, understand the upside, and back them directly inside the app.",
    metric: "03",
  },
  {
    ...
    body: "Investors share a pool of capital they can allocate to contributors building the mission.",
