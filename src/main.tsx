...
const chapters: Chapter[] = [
  {
    ...
    body: "Singularity turns a mission into a token backed funding system where builders and investors coordinate capital together.",
    cta: {
  ...
  },
  {
    ...
    body: "Shape a goal into a clear, fundable mission, whether it is growing a community, building a product, or coordinating a new initiative.",
    metric: "01",
  },
  {
    ...
    body: "Create a mission backed token with funding mechanics built in from the start.",
  ...
  },
  {
    ...
    body: "Give every mission a built in token sale so aligned investors can discover, understand, and back the mission directly inside the app.",
    metric: "03",
  },
  {
    eyebrow: "Dynamic treasury ownership",
    label: "Treasury",
    title: "Let investors allocate capital",
    body: "Top stakeholders earn the right to allocate capital toward work that moves the mission forward.",
      ...
      <section className="hero">
        ...
        <header className="nav">
          ...
          <nav className="social-links" aria-label="Social links">
            <a className="social-link github-link" href="https://github.com" aria-label="GitHub" target="_blank" rel="noreferrer">
            ...
            <a className="social-link telegram-link" href="https://t.me" aria-label="Telegram" target="_blank" rel="noreferrer">
            ...
            <a className="social-link" href="https://x.com" aria-label="X" target="_blank" rel="noreferrer">
              <svg viewBox="0 0 24 24" aria-hidden="true">
